...
function ConfirmPassword() {
  ...
  const [changeColorEmailLabel, setChangeColorEmailLabel] = useState(
    "black_email_address_label"
  );
  const [changeColorEmailInput, setChangeColorEmailInput] = useState(
    "black_email_address_input"
  );
  ...
  return (
    <div className="App">
      <div className="log">
        ...
        <div className="email">
          <div>
            <label className={changeColorEmailLabel}>
          ...
          <div>
            <input
              type="text"
              className={changeColorEmailInput}
        ...
        {incorrect ? (
          <div className="incorrect">
            ...
            <label className="invalid_email_password">
        ...
        <div>
          <button className="log_in " onClick={log_in}>
            <strong>ՄՈՒՏՔ ԳՈՐԾԵԼ</strong>
          </button>
        </div>
      </div>
    </div>
