...
function Communities() {
    ...
    console.log("store.getState().prog.program,",store.getState().prog.program,);
    useEffect(() => {
                ...
                arrow_icon_city && (
                  ...
                  <div ref={ref} className="NestedSelect">
                    <div className="city_checkbox">
                      <input type="checkbox" value={selectAllCity} defaultChecked={selectAllCity} onClick={() => selectAllCommunities(!selectAllCity)} />
