...
import { changeIsSelect, changeSupMoreInfo } from "../../../redux";

function SupportTypes({ isSelect, changeIsSelect, suppForMoreInfo, supErr }) {
  ...
  const selectSupport = (supportId, name) => {
                      ...
                      openCategory.some(item => item === categore.categoryid) ? (
                        <div className="support_types" >
                          ...
                          {categore.support.map((support, index) => (
                            ...
                            }} key={index} className="li" onClick={() => selectSupport(support.supportid, support.name)}>
                              {support.name}
                            </li>
                          ))}
